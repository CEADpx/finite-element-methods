...
function $\varphi$ is Lipschitz continuous: there is a constant $L>0$ such
that, with $\norm{\cdot}_2$ denoting the Euclidean norm,
...
assumed at the outset. These assumptions allow us to use traces, outward unit
normals, integration by parts, and Poincare-type inequalities without
